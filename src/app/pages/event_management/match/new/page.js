    ...
    try {
      ...
      const response = await fetch('/api/event_management', {
        ...
        body: JSON.stringify({
          ...
          description: `${formData.homeAway === 'home' ? 'Home' : 'Away'} match against ${formData.opponent}`,
  ...
  return (
    <div className="p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600">Create a new match for the academy</p>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g., Quick Touch vs Manchester United"
            />
          </div>

          {/* Opponent and Home/Away Row */}
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
              placeholder="Enter match venue/stadium"
            />
          </div>

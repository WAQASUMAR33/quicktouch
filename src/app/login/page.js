      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl shadow-2xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-white mb-2">Quick Touch</h1>
            <p className="text-white/70">Welcome back to your academy</p>
          </div>
          ...
          <div className="mt-6 p-4 bg-white/5 border border-white/10 rounded-xl backdrop-blur-sm">
            ...
            <div className="text-xs text-white/60 space-y-1">
              <p><strong>Admin:</strong> admin@quicktouch.com / admin123</p>
              <p><strong>Player:</strong> demo@quicktouch.com / demo123</p>
            </div>
          </div>
